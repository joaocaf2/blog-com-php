...
<body>
	<div id="container">
		...
		<p>
			<?php
			echo $artigo1['conteudo'];
			?>
		</p>
		<h2>
			<a href="o-que-e-metodologia-agil.html"> O que é Metodologia Ágil? </a>
		</h2>
		<p>Uma vez fui contratada por uma empresa que desenvolvia softwares e
			aplicativos para outras empresas.</p>
		<h2>
			<a href="como-e-o-funil-do-growth-hacking.html"> Como é o funil do
				Growth Hacking? </a>
		</h2>
